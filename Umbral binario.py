...
def binario(imagen,threshold):
    ...
    im2 = Image.new('1', (alto, ancho), "white")   #Creación de nueva imagen
    ...
    graficar(h2,"Histograma del umbral binario")       #Grafica histograma original
    return im2


imagen1=binario("C:\\Users\win10\Desktop\procesamiento de imagenes\A1.jpg",50)
imagen1=imagen1.save("C:\\Users\win10\Desktop\procesamiento de imagenes\\binario.jpg")

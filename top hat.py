...
apertura=Image.fromarray(apertura)
print(apertura.width,apertura.height)

subtract=subtract(img_gray,apertura)
...
plt.title('transformación top hat'), plt.xticks([]), plt.yticks([])
